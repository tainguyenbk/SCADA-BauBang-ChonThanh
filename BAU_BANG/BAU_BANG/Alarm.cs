...
namespace BAU_BANG
{
    public partial class Alarm : Form
    {
        ...
        public static bool DeepSetGetAdvanced(object obj, object another)
        {
            ...
            foreach (var property in obj.GetType().GetProperties())
            {
                ...
                objValue = anotherValue;
            }

            return result;
        }

        public void DeepSetGet(object obj, object another)
        {
            foreach (var property in obj.GetType().GetProperties())
            {
                var objValue = property.GetValue(obj);
